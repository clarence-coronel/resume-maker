export default function ResumeHeader({ name, email, phone, address}){
    return (
        <div className="w-full bg-blue-950 min-h-52 h-fit px-10 py-5 flex justify-center items-center flex-col gap-y-5" >
            ...
            <div className="text-white w-full h-14 flex flex-row flex-wrap items-center justify-center gap-5">
                {email != "" &&
                    <div className="h-full text-inherit flex flex-row items-center gap-x-1 text-sm"> 
